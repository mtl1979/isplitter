...
FileContextMenuExt::FileContextMenuExt(void) : m_cRef(1),
    m_pszMenuText(L"&Split with Image Splitter"),
    m_pszVerb("split"),
    m_pwszVerb(L"split"),
    m_pszVerbCanonicalName("ImageSplitterSplit"),
    m_pwszVerbCanonicalName(L"ImageSplitterSplit"),
    m_pszVerbHelpText("Split image file"),
    m_pwszVerbHelpText(L"Split image file")
{
...
void FileContextMenuExt::OnVerbOpenSplitter(HWND hWnd)
{
	SHELLEXECUTEINFOW sei = { sizeof(SHELLEXECUTEINFOW) };
	sei.hwnd = hWnd;
	sei.lpFile = L"ImageSplitter.exe";
	sei.lpParameters = this->m_szSelectedFile;
